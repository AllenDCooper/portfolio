  ...
  return (
    <main className={styles["home-container"]}>
      ...
      <article className={styles["bio"]}>
        <p>
          I am a technical program manager and full-stack engineer with over ten years of experience in edtech and educational publishing. I live in New York City with my wife and my cat.
        </p>
      </article>
      <section className={styles["nav-button-container"]}>
        ...
        <Link to="/project-management" className={styles["nav-button"]}>Project Management</Link>
